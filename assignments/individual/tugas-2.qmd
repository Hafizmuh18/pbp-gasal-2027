...
**Contributors:** FEIN - Alvin Christian Halim, REM - Malik Alifan Kareem
...
- [ ] Add unit tests that cover at least three test scenarios as follow:
  1. The URL is accessible and uses the correct template.
  2. Model data appears in the returned HTML response when the data is not empty.
  3. An empty message appears in the returned HTML response when the data is empty.
...
Individual Assignment 2 is released on **September 7, 2026** and is due no later than **September 14, 2026, 23:59 WIB**. This deadline is later than Tutorial 02's deadline on Wednesday, September 9, 2026.
...
- **4** - Goes beyond this week's expectations creatively - free to build on your own ideas, not just follow the given instructions.
...
- **4** - Code quality goes beyond this week's expectations, reflecting creativity and mature mastery - not just following the taught pattern.
...
- **4** - Git discipline and history go beyond this week's expectations, reflecting maturity and initiative in managing the project.
...
- **4** - Documentation and AI disclosure go beyond this week's expectations, reflecting mature depth and initiative.
