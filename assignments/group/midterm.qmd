...
format:
  ...
  docx: default
  revealjs:
    output-file: midterm-slide.html
    scrollable: true
format-links:
  - html
  - format: typst
...
Untuk mempermudah kalian dalam mengerjakan tugas kelompok, tim asdos telah menyiapkan [panduan lengkap](./midterm-guide.qmd) yang bisa jadi pegangan selama proses development.