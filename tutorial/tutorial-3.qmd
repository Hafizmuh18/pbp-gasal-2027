...
Setelah tugas dua, kamu diharapkan memiliki page HTML baru, disini sebagai contoh, saya telah memiliki `project.html`, isi kodenya adalah sebagai berikut: 

::: {.callout-important}
**Kode Contoh** - Kode dan implementasi yang akan saya jelaskan adalah contoh, sesuaikan dengan hasil dari tugas anda, jangan melakukan kopi paste kode-kode ini jika page yang anda implementasikan berbeda!
:::
...
### Step 2: Adapting the Page from Tutorial 2

After Tutorial 2, you should have a new HTML page. In this example, we already have `project.html`:

::: {.callout-important}
**Example Code** - The code and implementation explained here are examples. Adapt them to your own assignment, and do not copy these code blocks if your page has a different structure.
:::
