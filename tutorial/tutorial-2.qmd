...
::: {.callout-important}
**Menghubungkan ke Proyek Kamu** - Ganti data profil pada `context` dengan data dirimu sendiri. Pola yang sama dapat digunakan saat menambah halaman atau fitur baru: ambil data melalui *view*, kirim melalui *context*, lalu tampilkan pada *template*.
:::
...
::: {.callout-important}
**Connecting to Your Project** - Replace the profile values in the context with your own data. The same pattern applies whenever you add a new page or feature: retrieve data in a view, pass it through the context, and display it in a template.
:::
