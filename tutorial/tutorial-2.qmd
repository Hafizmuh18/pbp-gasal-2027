...
::: {.callout-note}
Sebelum dimulai, kamu perlu mengingat kembali bahwa direktori utama adalah direktori **terluar** (`portfolio`), sedangkan direktori proyek adalah direktori **di dalam** direktori utama (`myportfolio`).
:::
