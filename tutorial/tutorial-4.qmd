...
format:
  ...
  docx: default
  revealjs:
    output-file: tutorial-4-slide.html
    scrollable: true
format-links:
  - html
  - format: typst
...
::: {.callout-note title="Tanda `...` menandakan kode lainnya dalam berkas yang tidak perlu diubah"}
...
::: {.callout-note title="Untuk tutorial kali ini Anda tidak harus dapat memahami cara kerja `<script>`. Penggunaan `<script>` akan Anda pelajari di tutorial 5 minggu depan."}
